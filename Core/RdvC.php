...
class RdvC {
    ...
    function afficherRDVs()
    {
        ...
        $sql="SElECT d.ID_RDV,d.NOW_RDV,d.DATE_RDV,d.OBJET_RDV,d.ETAT_RDV,d.USER_ID  FROM rdv d ORDER BY NOW_RDV DESC";
        $db = config::getConnexion();
        try{
            $liste=$db->query($sql);
            return $liste;
...
function RechercheRDV($haja){
  ...
  $sql="SELECT ID_RDV,NOW_RDV,DATE_RDV,OBJET_RDV,ETAT_RDV,USER_ID FROM rdv WHERE OBJET_RDV LIKE '%$haja%' ORDER BY DATE_RDV DESC";
