...
<br><br>
    <div class="container" style="margin-top: 100px">
        <div class="facts">
            <div class="register">
                <form name="f" action="modifierclient.php" method="post">
                    <input type="hidden" name="id_client" value="<?php echo $id ?>">
                    <input placeholder="Votre nom" name="nom" type="text" value="<?php echo $nom; ?>">
                    <br>
                    <input placeholder="Votre prenom" name="prenom" type="text" style="margin: 14px 0 0 0;" value="<?php echo $prenom; ?> " required="">
                    <br>
                    <input placeholder="Adresse E-mail" name="email" type="email"value="<?php echo $email; ?>" required="">
                    <br>
                    <input placeholder="Date De Naissance" name="date" type="date" value="<?php echo $date; ?>" required="" style="    outline: none;
...
margin: 14px 0 0 0;">
<br>
                    <input placeholder="Ancien Mot De Passe" name="mdpa" type="password" id="mdpav"required="">
                    <br>
                    <input placeholder="Nouveau Mot De Passe" name="mdp" type="password" id="mdpv" required="">
                    <br>
                    <input placeholder="Confirmez Mot De Passe" name="mdp2" type="password" id="mdp2v" required="">
                    <table style="margin-top: 14px;">
                        <tr>
                            <td><label>+216</label></td>
                            <td width="100%"><input placeholder="Numéro De Telephone" name="numtel" type="text" required="" id="numtelv" value="<?php echo $numtel; ?>"></td>
                        </tr>
                    </table>
                    <br>
                    ...
                    <div class="alert alert-success agileits" id="success" style="display:none">
                        <strong>compte modifier!</strong>
                    </div>
                    <div class="sign-up">
                        <table>
                            <tr>
                                <td width="500px">  <input type="submit" id="bouton" value="Update Account">
                                    </form></td>
                                <td width="500px" style="">
